...
<div class="row mb-3">
    <div class="col">
       <h1 class="h3">Añadir cliente nuevo</h1> 
    </div>
</div>
            ...
            <form action="{{route('clientes.crear')}}" method="post">
                ...
                <div class="form-row mb-3">
                    <div class="col form-group">
                        ...
                        <input type="text" class="form-control rounded-0" name="nombre" id="nombre" placeholder="Nombre" value="{{old('nombre')}}">
                    ...
                    <div class="col form-group">
                        ...
                        <input type="text" class="form-control rounded-0" name="telefono" id="telefono" placeholder="Teléfono" value="{{old('telefono')}}">
                ...
                <div class="form-row mb-3">
                    <div class="col form-group">
                        <div class="col form-group">
                            ...
                            <input type="date" id="fecha_contratacion" name="fecha_contratacion" class="form-control rounded-0" value="{{old('fecha_contratacion')}}">
                        </div>
                    </div>
                </div>
                   <div class="form-row mb-3">
                       <div class="col form-group">
                           ...
                           <textarea name="notas_contratacion" id="notas_contratacion" class="form-control" cols="30" rows="10" placeholder="Notas de contratación"></textarea>
                       </div>
                   </div>
