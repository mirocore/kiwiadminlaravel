...
<div class="row mb-3">
    <div class="col">
       <h1 class="h3">Añadir servicio nuevo</h1> 
    </div>
</div>
               ...
               @csrf
                ...
                <div class="form-row mb-3">
                    <div class="col form-group">
                        ...
                        <textarea name="descripcion" id="descripcion" class="form-control rounded-0" placeholder="Descripción" cols="30" rows="10">{{ old('descripcion') }}</textarea>
                    </div>                     
                </div>
